...
describe('DBqueries', () => {
  ...
  describe('Create user', () => {
    ...
    beforeAll((done) => {
      Request.post({
        url: 'http://localhost:3001/database/createUser',
  ...
  describe('Adding matches', () => {
    ...
    beforeAll((done) => {
      Request.post({
        url: 'http://localhost:3001/database/addMatch',
        form: {
          'playerIDs': '76561198060465046,76561198120370069,76561198011319125,76561198151387780,'
  ...
  describe('bind match to user', () => {
    ...
    beforeAll((done) => {
      Request.post({
        url: 'http://localhost:3001/database/saveMatch',
  ...
  describe('get user\'s saved matches', () => {
    ...
    beforeAll((done) => {
      Request.post({
        url: 'http://localhost:3001/database/savedMatches',
